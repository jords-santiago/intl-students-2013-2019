...
SELECT [COUNTRY]
      ...
      ,[YEAR]
      ,[Value]
INTO [IntlEducation_Stats].[dbo].[temp1_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[RAW_OECD_EDU_ENRL]

/*
--  Checking contents of the table
SELECT TOP(100) *
FROM [IntlEducation_Stats].[dbo].[temp1_OECD_EDU_ENRL]
...
SELECT [COUNTRY]
      ...
      ,[YEAR]
      ,[Value]
INTO [IntlEducation_Stats].[dbo].[temp2_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp1_OECD_EDU_ENRL]
WHERE [SEX] = '_T'
...
--  Checking contents of the table
SELECT TOP(100) *
FROM [IntlEducation_Stats].[dbo].[temp2_OECD_EDU_ENRL]
...
DELETE FROM [IntlEducation_Stats].[dbo].[temp2_OECD_EDU_ENRL]
...
SELECT * FROM [IntlEducation_Stats].[dbo].[temp2_OECD_EDU_ENRL] WHERE [Value] like '%.%'
*/

-- Altered the table to have the Value as float first
ALTER TABLE [IntlEducation_Stats].[dbo].[temp2_OECD_EDU_ENRL]
...
INTO [IntlEducation_Stats].[dbo].[temp3_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp2_OECD_EDU_ENRL]

/*
SELECT TOP(100) * FROM [IntlEducation_Stats].[dbo].[temp3_OECD_EDU_ENRL]

SELECT COUNT(*)
FROM [IntlEducation_Stats].[dbo].[temp3_OECD_EDU_ENRL]
-- now has 455047 records

-- Check out the [COUNTRY] column, these values seem to resemble 3-character code (alpha-3)
SELECT DISTINCT [COUNTRY] FROM [IntlEducation_Stats].[dbo].[temp3_OECD_EDU_ENRL]

-- Check out the [ORIGIN] column, these values seem to resemble ISO 3166 2-character code (alpha-2)
SELECT DISTINCT [ORIGIN] FROM [IntlEducation_Stats].[dbo].[temp3_OECD_EDU_ENRL]
...
SELECT * INTO [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp3_OECD_EDU_ENRL]
WHERE [ORIGIN] IN (SELECT [2_DIGIT_CODE] FROM [IntlEducation_Stats].[dbo].[ISO_3166_COUNTRY_CODES]) OR [ORIGIN] ='XK'

/*
SELECT COUNT(*)
FROM [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL]
-- now has 426752 records

-- Checking the [COUNTRY] values that were not in IS0 3166
SELECT DISTINCT [COUNTRY] FROM [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL]
...
DELETE FROM [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL]
WHERE [COUNTRY] NOT IN (SELECT [3_DIGIT_CODE] FROM [IntlEducation_Stats].[dbo].[ISO_3166_COUNTRY_CODES])
...
SELECT DISTINCT EDUCATION_LEV FROM [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL]
...
/*
SELECT TOP(100) * FROM [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL]
...
SELECT
	...
	,A.[YEAR]
	,A.[VAL]
INTO [IntlEducation_Stats].[dbo].[temp5_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp4_OECD_EDU_ENRL] A
LEFT JOIN
...
/*
SELECT COUNT(*)
FROM [IntlEducation_Stats].[dbo].[temp5_OECD_EDU_ENRL]
-- now has 289077 records
*/
...
INTO [IntlEducation_Stats].[dbo].[temp6_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp5_OECD_EDU_ENRL] A
LEFT JOIN
[IntlEducation_Stats].[dbo].[ISO_3166_COUNTRY_CODES_W_KSV] B
ON A.ORIGIN = B.[2_DIGIT_CODE]

SELECT * INTO [IntlEducation_Stats].[dbo].[FINAL_OECD_EDU_ENRL_2013_2019]
FROM [IntlEducation_Stats].[dbo].[temp6_OECD_EDU_ENRL]

-- Table [IntlEducation_Stats].[dbo].[FINAL_OECD_EDU_ENRL_2013_2019] will now be used to visualize
-- the total number of internation students in Tableau (exported as a CSV) 
...
SELECT * FROM [IntlEducation_Stats].[dbo].[temp6_OECD_EDU_ENRL]
...
SELECT
	...
	,A.[YEAR]
	,A.[VAL] AS NUM_OF_STUDENTS
INTO [IntlEducation_Stats].[dbo].[temp7_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp5_OECD_EDU_ENRL] A
LEFT JOIN
[IntlEducation_Stats].[dbo].[ISO_3166_COUNTRY_CODES_W_KSV] B
ON A.ORIGIN = B.[2_DIGIT_CODE]
...
INTO [IntlEducation_Stats].[dbo].[temp8_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp7_OECD_EDU_ENRL]
...
INTO [IntlEducation_Stats].[dbo].[temp9_OECD_EDU_ENRL]
FROM [IntlEducation_Stats].[dbo].[temp8_OECD_EDU_ENRL] A
INNER JOIN
(
...
-- for year 2013-2019
SELECT *
FROM [IntlEducation_Stats].[dbo].[temp9_OECD_EDU_ENRL]
WHERE POPULATION=0

DELETE FROM [IntlEducation_Stats].[dbo].[temp9_OECD_EDU_ENRL]
WHERE POPULATION=0
